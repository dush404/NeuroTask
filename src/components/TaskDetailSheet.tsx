...
const PRIORITY_OPTIONS: { value: Priority; label: string; color: string }[] = [
  { value: "p1", label: "High", color: Colors.priorityHigh },
  { value: "p2", label: "Med", color: Colors.priorityMedium },
  { value: "p3", label: "Low", color: Colors.priorityLow },
  { value: "p4", label: "None", color: Colors.textMuted },
];
